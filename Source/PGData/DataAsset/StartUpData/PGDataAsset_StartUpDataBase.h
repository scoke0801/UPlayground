...
public:
	...
	virtual void GiveToAbilitySystemComponent(UAbilitySystemComponent* InASCToGive, int32 ApplyLevel = 1);

protected:
	void GrantAbilities(const TArray<TSubclassOf<UGameplayAbility>>& inAbilitiesToGive,
		UAbilitySystemComponent* InASCToGive, int32 ApplyLevel = 1);
