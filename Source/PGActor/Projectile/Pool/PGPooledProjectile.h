...
public:
	// 투사체 발사
	virtual void Fire(const FGenericTeamId OwnerTeamId, const FVector& StartLocation, const FVector& Direction, float Speed = 1000.0f, float InDamage = 10.0f) override;
